...
async def on_ready():
    ...
    if panel_channel:
        ...
        embed.add_field(name="✅ Player Signup", value="Sign up to participate in the league.", inline=False)
        embed.add_field(name="🏷️ Create Team", value="Create a team with players and register it.", inline=False)
        embed.add_field(name="📅 Propose Match", value="Propose a match between your team and another.", inline=False)
        embed.add_field(name="📊 Propose Score", value="Submit scores for a match. Modes: Capture / Payload.", inline=False)
        embed.add_field(name="➕ Request to Join Team", value="Request to join a team. Captain must approve.", inline=False)
        embed.add_field(name="🚪 Leave Team", value="Leave your current team (if not captain).", inline=False)
        embed.add_field(name="❌ Unsignup", value="Remove yourself from the league entirely.", inline=False)
        embed.add_field(name="❗ Disband Team", value="Disband your team (Captain / Dev only).", inline=False)

        embed.set_footer(text="Some actions require being a captain or dev.")
