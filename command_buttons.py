...
# -------------------- CREATE TEAM --------------------
    ...
    async def propose_match(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        class AcceptDenyMatchView(discord.ui.View):
            def __init__(self, parent, team_a, team_b, proposed_date_str, match_type="assigned", week_number=None, proposed_datetime=None):
            ...
            async def select_time(self, interaction: discord.Interaction, button: discord.ui.Button):
                ...
                async def selected(inner: discord.Interaction):
                    ...
                    if all(k in self.date_time and self.date_time[k] for k in required_fields):
                        ...
                        view = SubmitProposalView(self.parent, self.date_time, self.team_a, self.team_b, self.is_challenge)
                    else:
        ...
        class SubmitProposalView(discord.ui.View):
            def __init__(self, parent, date_time, team_a, team_b, is_challenge):
                super().__init__(timeout=300)
                self.parent = parent
            ...
            async def submit(self, interaction: discord.Interaction, button: discord.ui.Button):
                ...
                view = AcceptDenyMatchView(
                    ...
                    week_number=self.parent.week_number if not self.is_challenge else None,
    ...
    async def propose_score(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        class ConfirmScoreView(discord.ui.View):
            ...
            async def accept(self, interaction: discord.Interaction, button: discord.ui.Button):
                ...
                match_id = self.match.get("match_id", "Challenge")
                ...
                score_channel_id = self.parent.bot.config.get("score_channel_id") or self.parent.bot.config.get("results_channel_id")
                ...
                # Notify and cleanup
                await safe_send(interaction, "✅ Scores accepted and saved!", ephemeral=True)
